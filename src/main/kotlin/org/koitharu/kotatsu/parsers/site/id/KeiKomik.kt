...
internal class Keikomik(context: MangaLoaderContext) :
    PagedMangaParser(context, MangaParserSource.KEIKOMIK, 20) {
    ...
    override fun getRequestHeaders(): Headers = Headers.Builder()
        ...
        .add("Referer", "https://keikomik.web.id/")
    ...
    override suspend fun getListPage(page: Int, order: SortOrder, filter: MangaListFilter): List<Manga> {
        ...
        val rawList = doc.select("div.manga-card, .manga-item, article, .series-item").mapNotNull { el: Element ->
